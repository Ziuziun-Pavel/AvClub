...
<section class="section_content section_opinion">
	<div class="container">
		...
		<div class=" content__cont">
			...
			<div class="opinion__row or__row row">
				...
				<?php if($journals) { ?>
					...
					<?php foreach($journals as $journal) {$m++; ?>
						<div class="opinion__outer col-sm-6 col-lg-4 col-xl-3">
							<?php require(DIR_TEMPLATE . 'avclub/template/_include/journal-opinion.tpl'); ?>
						</div>
					<?php } ?>

					<?php if($banner) { ?>
						<div class="opinion__outer opinion__outer-banner col-sm-6 col-lg-4 col-xl-3">
							<?php require(DIR_TEMPLATE . 'avclub/template/_include/journal-banner.tpl'); ?>
						</div>
					<?php } ?>

					<div class="opinion__outer opinion__outer-master col-sm-6 col-lg-4 col-xl-3">
