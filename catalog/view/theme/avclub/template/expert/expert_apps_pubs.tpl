...
<div class="expreg expreg-apps-pubs ">
    <div class="expreg__info expreg__info-pubs">

        <div class="expreg__name expreg__name-pubs">
            <?php
        ...
        <div class="expreg__date expreg__date-pubs">
            <span>
               <?php
                    if ($app['status']):
        ...
        <div class="expreg__btns expreg__btns-pubs" style="font-size: 13px;">
...
-->
        ...
        <?php if (!empty($app["answers"])) { ?>
        <div class="question-btn5">
            Показать ответы
            <div class="question-btn5--arrow">
...
<script>
    $(document).ready(function () {
        $('.expreg__btns-pubs .modalshow').on('click', function (e) {
            e.preventDefault();
        ...
        function loadPubs() {
            $.ajax({
                ...
                success: function (json) {
                    ...
                    if ($('.expertnav__tabs a.apps_pubs').hasClass('active')) {
                        $('#content-apps-pubs').removeClass('d-none');
                        $('#content-apps-pubs .expreg-apps-pubs').removeClass('d-none');
        ...
        $(document).off('click', '.question-btn5').on('click', '.question-btn5', function () {
            $(this).closest('.expreg__info.expreg__info-pubs').find('.answers__wrapper').toggleClass('d-none');
            console.log('click5');

            if ($(this).closest('.expreg__info.expreg__info-pubs').find('.answers__wrapper').hasClass('d-none')) {
                $(this).html(`
            Показать ответы
            <div class="question-btn5--arrow">
                <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none">
