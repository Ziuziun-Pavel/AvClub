...
<div class="expreg expreg-apps-ads ">
    <div class="expreg__info expreg__info-ads">

        <div class="expreg__name expreg__name-ads">
            <?php
        ...
        <div class="expreg__date expreg__date-ads">
            <span>
               <?php
                    if ($app['status']):
        ...
        <div class="expreg__btns expreg__btns-ads" style="font-size: 13px;">
...
<script>
    $(document).ready(function () {
        $('.expreg__btns-ads .modalshow').on('click', function (e) {
            e.preventDefault();
        ...
        function loadAds() {
            $.ajax({
                ...
                success: function (json) {
                    ...
                    if ($('.expertnav__tabs a.apps_ads').hasClass('active')) {
                        $('#content-apps-ads').removeClass('d-none');
                        $('#content-apps-ads .expreg-apps-ads').removeClass('d-none');
        ...
        $(document).off('click', '.question-btn3').on('click', '.question-btn3', function () {
            $(this).closest('.expreg__info.expreg__info-ads').find('.answers__wrapper').toggleClass('d-none');
            console.log('click4');

            if ($(this).closest('.expreg__info.expreg__info-ads').find('.answers__wrapper').hasClass('d-none')) {
                $(this).html(`
            Показать ответы
            <div class="question-btn3--arrow">
                <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none">
