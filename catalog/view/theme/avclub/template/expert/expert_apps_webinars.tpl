...
<div class="expreg expreg-apps-webinars ">
    <div class="expreg__info expreg__info-webinars">

        <div class="expreg__name expreg__name-webinars">
            <?php
        ...
        <div class="expreg__date expreg__date-webinars">
            <span>
               <?php
                    if ($app['status']):
        ...
        <div class="expreg__btns expreg__btns-webinars" style="font-size: 13px;">
...
<script>
    $(document).ready(function () {
        $('.expreg__btns-webinars .modalshow').on('click', function (e) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                success: function (json) {
                    ...
                    if ($('.expertnav__tabs a.apps_forums').hasClass('active')) {
                        ...
                        $('#content-apps-webinars .expreg-apps-webinars').removeClass('d-none');
        ...
        $(document).off('click', '.question-btn2').on('click', '.question-btn2', function () {
            $(this).closest('.expreg__info.expreg__info-webinars').find('.answers__wrapper').toggleClass('d-none');
            console.log('click3');

            if ($(this).closest('.expreg__info.expreg__info-webinars').find('.answers__wrapper').hasClass('d-none')) {
                $(this).html(`
            Показать ответы
            <div class="question-btn2--arrow">
                <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none">
