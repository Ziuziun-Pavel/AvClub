<div class="master__item">
	<div class="master__img">
		<div class="master__left">
			...
			<a href="<?php echo $master['href']; ?>" class="btn btn-red master__reg" target="_blank">
	...
	<div class="master__data">
		...
		<div class="master__more">
			<a href="<?php echo $master['href']; ?>" target="_blank"><svg class="ico ico-center"><use xlink:href="#dots" /></svg></a>
		</div>
		<?php */ ?>
