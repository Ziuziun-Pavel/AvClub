			...
			<form id="form-edit-expert" class="edit__content col-xl-9">
				...
				<div class="edit__back">
					<a href="<?php echo $back; ?>" class="link__outer">
						<svg class="ico"><use xlink:href="#long-arrow-left">
						</svg> <span><span class="link">Назад</span></span>
					</a>
				</div>
				...
				<div class="edit__image">
					<a href="#modal-edit-image" class="edit__image--image">
						<img src="<?php echo $image; ?>" alt="" id="edit-image" data-placeholder="<?php echo $placeholder; ?>">
						<svg class="ico ico-center"><use xlink:href="#photo"></svg>
						</a>
					...
					<div class="edit__inputs row">
						...
						<div class="regform__outer regform__outer-sub col-12">
							<div class="regform__edit">
								<svg class="ico"><use xlink:href="#edit" /></svg> 
						...
						<div class="regform__outer col-12 col-md-6">
							<div class="regform__inp regform__inp-plh">
								<input type="text" name="name" value="<?php echo $user['name']; ?>" class="regform__input <?php echo $user['name'] ? 'valid' : ''; ?>" autocomplete="false" data-input-change />
						...
						<div class="regform__outer col-12 col-md-6">
							<div class="regform__inp regform__inp-plh">
								<input type="text" name="lastname" value="<?php echo $user['lastname']; ?>" class="regform__input <?php echo $user['lastname'] ? 'valid' : ''; ?>" data-input-change />
						...
						<div class="regform__outer col-12 col-md-6">
							<div class="regform__inp regform__inp-plh">
								<input type="text" name="email" value="<?php echo $user['email']; ?>" class="regform__input  <?php echo $user['email'] ? 'valid' : ''; ?>" data-input-change />
						...
						<div class="regform__outer col-12 col-md-6">
							<div class="regform__inp regform__inp-plh">
								<input type="tel" name="telephone" value="<?php echo $user['telephone']; ?>" class="regform__input  <?php echo $user['telephone'] ? 'valid' : ''; ?>" data-input-change />
						...
						<div class="regform__outer col-12">
							<div class="regform__inp regform__inp-plh">
								<input type="text" name="post" value="<?php echo $user['exp']; ?>" class="regform__input <?php echo $user['exp'] ? 'valid' : ''; ?>" data-input-change />
						...
						<div class="regform__outer col-12">
							<div class="regform__inp regform__inp-plh">
								<input type="text" name="company" value="<?php echo $user['company']; ?>" class="regform__input <?php echo $user['company'] ? 'valid' : ''; ?>" autocomplete="false" data-input-change />
								<div class="regform__find">+ Найти</div>
								<div class="regform__plh">Компания</div>
							</div>
						</div>

						<div class="regcompany col-12 " style="<?php echo !empty($user['company_status']) && $user['company_status'] === 'new' ? 'display:block;' : ''; ?>">
							<div class="regcompany__row row">

								<div class="regform__outer col-12">
									<div class="regform__inp regform__inp-plh">
										<input type="text" name="city" value="<?php echo $user['city']; ?>" class="regform__input" data-input-change />
										<div class="regform__plh">Город работы</div>
									</div>
								</div>
								<div class="regform__outer company--new col-12">
									<div class="regform__inp regform__inp-plh">
										<input type="tel" name="company_phone" value="<?php echo $user['company_phone']; ?>" class="regform__input" autocomplete="false" data-input-change />
										<div class="regform__plh">Телефон компании</div>
									</div>
								</div>
								<div class="regform__outer company--new col-12">
									<div class="regform__inp regform__inp-plh">
										<input type="text" name="company_site" value="<?php echo $user['company_site']; ?>" class="regform__input" autocomplete="false" data-input-change />
						...
						<div class="regform__outer col-12 d-none">
							<div class="regform__inp regform__inp-plh regform__inp-textarea">
								<div class="regform__textarea" contentEditable="true" oninput="textareainp(this);"><?php echo $user['expertise']; ?></div>
								<textarea name="expertise" data-input-change class="<?php echo $user['expertise'] ? 'valid' : ''; ?>"><?php echo $user['expertise']; ?></textarea>
						...
						<div class="regform__outer col-12">
							<div class="regform__inp  regform__inp-plh regform__inp-textarea">
								<div class="regform__textarea" contentEditable="true" oninput="textareainp(this);"><?php echo $user['useful']; ?></div>
								<textarea name="useful" data-input-change class="<?php echo $user['useful'] ? 'valid' : ''; ?>"><?php echo $user['useful']; ?></textarea>
						...
						<div class="regform__outer col-12">
							<div class="regform__inp  regform__inp-plh regform__inp-textarea">
								<div class="regform__textarea" contentEditable="true" oninput="textareainp(this);"><?php echo $user['regalia']; ?></div>
								<textarea name="regalia" data-input-change class="<?php echo $user['regalia'] ? 'valid' : ''; ?>"><?php echo $user['regalia']; ?></textarea>
								<div class="regform__plh">Заслуги  и регалии</div>
							</div>
						</div>

						<div class="regform__btns regform__outer col-12">
							<button type="button" class="regform__btn regform__btn-save btn btn-red" id="button-edit-save" disabled>
								<span>
									Сохранить изменения
								</span>
							</button>
						...
						<?php /* ?>
						<input type="hidden" name="company_status" value="<?php echo !empty($user['company_status']) ? $user['company_status'] : ''; ?>" />
