...
<div class="regdata__form">
	...
	<form class="regform row" id="register-newuser">
		...
		<?php if(!empty($show_name_fields)) { ?>
			...
			<div class="regform__outer col-12 col-md-6">
				<div class="regform__inp">
					<input type="text" name="lastname" value="<?php echo $user['lastname']; ?>" class="regform__input " placeholder="Фамилия" />
				</div>
			</div>
		<?php } ?>
		...
		<div class="regform__outer col-12">
			<div class="regform__inp">
				<input type="text" name="email" value="<?php echo $user['email']; ?>" class="regform__input " />
		...
		<div class="regform__outer col-12">
			<div class="regform__inp">
				<input type="text" name="post" value="<?php echo $user['post']; ?>" class="regform__input" />
		...
		<div class="regform__outer col-12">
			<div class="regform__inp">
				<input type="text" name="company" value="<?php echo $user['company']; ?>" class="regform__input" autocomplete="false" />
		...
		<div class="regcompany col-12 " style="<?php echo !empty($user['company_status']) && $user['company_status'] === 'new' ? 'display:block;' : ''; ?>">
			<div class="regcompany__row row">
				...
				<div class="regform__outer col-12">
					<div class="regform__inp">
						<input type="text" name="city" value="<?php echo $user['city']; ?>" class="regform__input" placeholder="Город работы" />
					</div>
				</div>
				<div class="regform__outer company--new col-12">
					<div class="regform__inp">
						<input type="tel" name="company_phone" value="<?php echo $user['company_phone']; ?>" class="regform__input" autocomplete="false" placeholder="Телефон компании" />
					</div>
				</div>
				<div class="regform__outer company--new col-12">
					<div class="regform__inp">
						<input type="text" name="company_site" value="<?php echo $user['company_site']; ?>" class="regform__input" autocomplete="false" placeholder="Сайт компании" />
					</div>
				</div>
					...
					<div class="regcompact__list ">
						<?php foreach($activity as $item) { ?>
							...
							<label class="regcompact__item">
								<input type="checkbox" name="company_activity[]" value="<?php echo $item; ?>" <?php echo $active_act ? 'checked' : ''; ?>>
