	...
	<div class="regpromo">
		...
		<div class="regpromo__bottom">
			...
			<div class="regpromo__text">
				Укажите промокод при регистрации на форуме, чтобы получить эксклюзивные преимущества: доступ в закрытые зоны, участие в специальных мероприятиях, а также бонусы и подарки от участников и организаторов.
			</div>
		</div>
