...
class ControllerExtensionModuleSeoUrlGenerator extends Model {
  ...
  public function index() {
    ...
    $data['entry_strtolower'] = $this->language->get('entry_strtolower');
    ...
    $data['seo_url_generator_strtolower'] = '';
    if (isset($this->request->post['seo_url_generator_strtolower']))
      $data['seo_url_generator_strtolower'] = $this->request->post['seo_url_generator_strtolower'];
    else
      $data['seo_url_generator_strtolower'] = $this->config->get('seo_url_generator_strtolower');  
    
    $data['a_strtolower_values'] = array(
    ...
    if (!$data['seo_url_generator_formula_product']) $data['seo_url_generator_formula_product'] = '[product_name]';
  ...
  protected function validateForm() {
    ...
    if (!$this->request->post['seo_url_generator_formula_product']) {
      ...
      if ( false === strstr($this->request->post['seo_url_generator_formula_product'], '[product_name]')
        && false === strstr($this->request->post['seo_url_generator_formula_product'], '[model]') 
        && false === strstr($this->request->post['seo_url_generator_formula_product'], '[sku]') ) {        
        $this->error['errors']['formula_product'] = $this->language->get('error_formula_product');        
      } else {
