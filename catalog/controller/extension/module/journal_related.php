...
class ControllerExtensionModuleJournalRelated extends Controller {
	public function index() {
		...
		$results = $this->model_journal_journal->getRelated($journal_id);

		$data['heading_title'] = $this->config->get('journal_related_title');
		...
		return $this->load->view('extension/module/journal_related', $data);
	}
}
