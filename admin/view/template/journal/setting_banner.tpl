			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-attribute" class="form-horizontal">
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="journal_banner_link" value="<?php echo $journal_banner_link; ?>" placeholder="<?php echo $entry_link; ?>"  class="form-control" />
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							<input type="hidden" name="journal_banner_image" value="<?php echo $journal_banner_image; ?>" id="input-image" />
						</div>
					</div>
				</form>
			</div>
