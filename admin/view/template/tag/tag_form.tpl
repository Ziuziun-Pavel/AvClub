								...
								<?php foreach ($languages as $language) { ?>
									<div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
										<div class="form-group required">
											...
											<div class="col-sm-10">
												<input type="text" name="tag_description[<?php echo $language['language_id']; ?>][title]" value="<?php echo isset($tag_description[$language['language_id']]) ? $tag_description[$language['language_id']]['title'] : ''; ?>" placeholder="<?php echo $entry_title; ?>" id="input-title<?php echo $language['language_id']; ?>" class="form-control" />
										...
										<div class="form-group ">
											...
											<div class="col-sm-10">
												<textarea name="tag_description[<?php echo $language['language_id']; ?>][description]" placeholder="<?php echo $entry_description; ?>" id="input-description<?php echo $language['language_id']; ?>" data-lang="<?php echo $lang; ?>" class="form-control summernote"><?php echo isset($tag_description[$language['language_id']]) ? $tag_description[$language['language_id']]['description'] : ''; ?></textarea>
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="text" name="tag_description[<?php echo $language['language_id']; ?>][meta_h1]" value="<?php echo isset($tag_description[$language['language_id']]) ? $tag_description[$language['language_id']]['meta_h1'] : ''; ?>" placeholder="<?php echo $entry_meta_h1; ?>" id="input-meta-h1<?php echo $language['language_id']; ?>" class="form-control" />
												<?php if (isset($error_meta_title[$language['language_id']])) { ?>
													<div class="text-danger"><?php echo $error_meta_title[$language['language_id']]; ?></div>
												<?php } ?>
											</div>
								...
								<table class="table table-bordered table-hover">
									...
									<tbody>
										<tr>
											...
											<td class="text-left"><select name="tag_layout[0]" class="form-control">
												<option value=""></option>
...
<script>
	$('input[name=\'author_search\']').autocomplete({
		...
		'select': function(item) {
			$('input[name=\'author_search\']').val('').addClass('hidden');
			$('.author__val').removeClass('hidden');
			$('.author__val span').html('<strong>' + item['label'] + '</strong><br><small>'+item['exp']+'</small>');
			$('.author__val input').val(item['value']);
		}
	});

	$(document).on('click', '.author__del', function(e) {
		e.preventDefault();
		$('input[name=\'author_search\']').val('').removeClass('hidden');
		$('.author__val').addClass('hidden');
		$('.author__val span').html('');
		$('.author__val input').val('');
	});
</script>
...
<script type="text/javascript">
	...
	<?php } else { ?>
		...
		$('#generateUrlOnEdit').click(function(e){
			...
			data = {
				name           : 'tag-' + $('#input-title' + config_language_id).val(),
				essence        : 'tag',
