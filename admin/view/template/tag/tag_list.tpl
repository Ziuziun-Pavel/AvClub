                ...
                <?php foreach ($tags as $tag) { ?>
                  <tr>
                    ...
                    <?php } else { ?>
                      ...
                      <?php } ?></td>
                      <td class="text-left"><?php echo $tag['title']; ?></td>
                      <td class="text-right"><a href="<?php echo $tag['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                    </tr>
                  <?php } ?>
                <?php } else { ?>
                  <tr>
