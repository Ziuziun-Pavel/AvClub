			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal" id="form-meta">
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="av_company[bread]" value="<?php echo $meta['bread']; ?>" placeholder="<?php echo $entry_bread; ?>" class="form-control" />
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="av_company[meta_h1]" value="<?php echo $meta['meta_h1']; ?>" placeholder="<?php echo $entry_meta_h1; ?>" class="form-control" />
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<textarea name="av_company[description]" placeholder="<?php echo $entry_meta_description; ?>" id="input-description" class="form-control summernote"><?php echo $meta['description']; ?></textarea>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label"><?php echo $entry_meta_title; ?></label>
						<div class="col-sm-10">
							<input type="text" name="av_company[meta_title]" value="<?php echo $meta['meta_title']; ?>" placeholder="<?php echo $entry_meta_title; ?>" class="form-control" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label"><?php echo $entry_meta_description; ?></label>
						<div class="col-sm-10">
							<textarea name="av_company[meta_description]" rows="5" placeholder="<?php echo $entry_meta_description; ?>" class="form-control"><?php echo $meta['meta_description']; ?></textarea>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label"><?php echo $entry_meta_keyword; ?></label>
						<div class="col-sm-10">
							<textarea name="av_company[meta_keyword]" rows="5" placeholder="<?php echo $entry_meta_keyword; ?>" class="form-control"><?php echo $meta['meta_keyword']; ?></textarea>
						</div>
					</div>
