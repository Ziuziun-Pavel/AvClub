      ...
      <div class="row">
        <div class="col-sm-3">
          <div class="form-group">
            ...
            <input type="text" name="filter_name" value="<?php echo $filter_name; ?>" placeholder="<?php echo $entry_title; ?>" id="input-name" class="form-control" />
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            ...
            <tbody>
              <?php if ($companies) { ?>
                <?php foreach ($companies as $company) { ?>
                  <tr style="<?php echo $company['status'] ? '' : 'background:#ffe5e9;'; ?>">
                    ...
                    <?php } else { ?>
                      ...
                      <?php } ?></td>
                      <td class="text-left"><?php echo $company['title']; ?></td>
                      <td class="text-right">
                        <?php if(!empty($company['update_link'])) { ?>
                          <a href="<?php echo $company['update_link']; ?>" class="btn btn-warning" target="_blank"><i class="fa fa-refresh"></i></a>
                        <?php } ?>
                        <a href="<?php echo $company['view']; ?>" data-toggle="tooltip" title="<?php echo $button_view; ?>" class="btn btn-info" target="_blank"><i class="fa fa-eye"></i></a>
                        <a href="<?php echo $company['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                      </td>
                    </tr>
                  <?php } ?>
                <?php } else { ?>
...
<script type="text/javascript">
  $('#button-filter').on('click', function() {
    url = 'index.php?route=company/company&token=<?php echo $token; ?>';
