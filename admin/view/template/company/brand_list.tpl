  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        ...
        <button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-brand').submit() : false;"><i class="fa fa-trash-o"></i></button>
      </div>
            ...
            <tbody>
              <?php if ($brands) { ?>
                <?php foreach ($brands as $brand) { ?>
                  <tr>
                    <td class="text-center"><?php if (in_array($brand['brand_id'], $selected)) { ?>
                    ...
                    <?php } else { ?>
                      ...
                      <?php } ?></td>
                      <td class="text-left"><?php echo $brand['title']; ?></td>
